...
.ct { FONT: 9px Arial Narrow; COLOR: black }
...
if Request.Form("rdCobraBoleto") = "Não" or Request.Form("rdCobraBoleto") = "Não" then
	vValorTaxaBoleto = 0
end if

vContratante = Request.QueryString("CONT_ID")
if vContratante = "" then vContratante = 0

Session("FUNC_ID") = Request.QueryString("recuperador")
Session("FILI_ID") = "1"

vTipoBoleto = Request.QueryString("tipoboleto")

vQtdboletos = 0
Dim vE

'vE = Request.QueryString("endereco")
vE = 1
vCTRA_ID = Request.QueryString("ctra_id")
...
Set rsParcelas = BD.Execute("SELECT BOAV_ID FROM BOLETOS_AVULSOS WHERE CTRA_ID = " & vCTRA_ID)
...
Do While Not rsParcelas.EOF
	...
	vBoletos = vBoletos & rsParcelas(0)
